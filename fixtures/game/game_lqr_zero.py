"""Trusted fixture candidate: zero-disturbance LQR fallback.
...
the standard LQR Riccati recursion that ignores the disturbance.  Self-
reported metrics are never trusted by the host.
"""
