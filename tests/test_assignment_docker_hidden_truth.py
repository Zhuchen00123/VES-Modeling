"""R22: read-only problem mount in the Docker runner (real attack when available)."""
...
for p in ["/data/hidden_test_outcomes.csv", "/host/hidden_test_outcomes.csv",
          "/data/hidden_test_transactions.csv", "/data/train.csv",
...
with open("/output/solution.json", "w", encoding="utf-8") as fh:
    json.dump({"assignment": [1, 0, 2], "probe": found}, fh)
'''
