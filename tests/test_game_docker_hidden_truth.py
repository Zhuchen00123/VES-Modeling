"""R31: read-only problem mount in the Docker runner (real attack)."""
...
with open("/output/solution.json", "w", encoding="utf-8") as fh:
    json.dump({"control": [[-2.0], [-1.0]], "probe": found,
               "horizon_seen": problem["horizon"]}, fh)
'''
