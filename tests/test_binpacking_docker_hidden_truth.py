"""R24: read-only problem mount in the Docker runner (real attack when available)."""
...
for p in ["/data/hidden_parameters.json", "/host/hidden_parameters.json",
          "/data/hidden_test_outcomes.csv", "/data/train.csv",
...
with open("/output/solution.json", "w", encoding="utf-8") as fh:
    json.dump({"assignment": [0, 1, 0, 1, 2], "probe": found}, fh)
'''
