"""Applying a clustering solution to caller-provided data (R12).
...
reference labels the only successful status is ``produced_unverified`` and no
ARI/NMI/V-measure is ever produced.
"""
