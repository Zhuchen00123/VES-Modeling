"""Applying an ODE solution to caller-provided data (R11).
...
hidden test values the only successful status is ``produced_unverified`` and
no RMSE/MAE is ever produced.
"""
    ...
    if not run_result.succeeded:
        ...
        try:
            ...
            validate_predictions(
                ...
                key_columns=(
                    contract.trajectory_id_column or "trajectory_id",
