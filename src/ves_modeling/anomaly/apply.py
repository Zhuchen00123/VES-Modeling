"""Applying an anomaly solution to caller-provided data (R13).
...
hidden labels the only successful status is ``produced_unverified`` and no
AUROC/AP/F1 is ever produced.
"""
